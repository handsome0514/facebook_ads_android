...
public class StudentNotificationAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (rowView == null) {
           ...
           /* viewHolder.notificationDetailTV.getSettings().setJavaScriptEnabled(true);
            viewHolder.notificationDetailTV.getSettings().setBuiltInZoomControls(true);
            viewHolder.notificationDetailTV.getSettings().setLoadWithOverviewMode(true);
            viewHolder.notificationDetailTV.getSettings().setDefaultTextEncodingName("utf-8");
            viewHolder.notificationDetailTV.getSettings().setUseWideViewPort(true);
            viewHolder.notificationDetailTV.getSettings().setDefaultFontSize(40);*/
