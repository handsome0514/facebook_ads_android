...
import com.edu.magika.adapters.StudentOnlineExamResultAdapter;
...
public class StudentOnlineExamResult extends AppCompatActivity {
   ...
   CardView card_view_outer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showBannerAd(StudentOnlineExamResult.this);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showInterstitialAd(StudentOnlineExamResult.this);
                finish();
            }
        });
    ...
    public void initializeAds()
    {
        MobileAds.initialize(this, new OnInitializationCompleteListener() {
            ...
            public void onInitializationComplete(@NonNull InitializationStatus initializationStatus) {
                ...
                AdLoader adLoader = new AdLoader.Builder(StudentOnlineExamResult.this, getString(R.string.nativead))
