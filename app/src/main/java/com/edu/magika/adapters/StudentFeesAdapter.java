...
import com.edu.magika.students.Payment;
import com.edu.magika.students.StudentFees;
import com.edu.magika.students.StudentOfflinePayment;
...
public class StudentFeesAdapter extends RecyclerView.Adapter<StudentFeesAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView dueDateText, amountText, fineText, discountText, paidAmtText, balanceAmtText;
        ...
        public MyViewHolder(View rowView) {
            ...
            dueDateText = rowView.findViewById(R.id.dueDateText);
            amountText = rowView.findViewById(R.id.amountText);
            fineText = rowView.findViewById(R.id.fineText);
            discountText = rowView.findViewById(R.id.discountText);
            paidAmtText = rowView.findViewById(R.id.paidAmtText);
            balanceAmtText = rowView.findViewById(R.id.balanceAmtText);
    ...
    private void showFeesCard(MyViewHolder viewHolder, final int position) {
        ...
        System.out.println("Feee"+amtList.get(position));
...
//            viewHolder.payBtn.setVisibility(View.GONE);
            ...
            viewHolder.feesAmtTV.setVisibility(View.VISIBLE);
            viewHolder.feefineTV.setVisibility(View.VISIBLE);
            viewHolder.fineTV.setVisibility(View.VISIBLE);
            viewHolder.discountTV.setVisibility(View.VISIBLE);
            viewHolder.feesPaidAmtTV.setVisibility(View.VISIBLE);
            viewHolder.feesDueAmtTV.setVisibility(View.VISIBLE);
