...
import com.edu.magika.adapters.StudentFeesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // transportdueDateList, transportamtfineList, transportpaidAmtList, transportdiscAmtList, transportbalanceAmtList, transportfeesDepositIdList,transportamtList,transportfineAmtList,transportstatusList);
        ...
        offlinePayment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(StudentFees.this, com.edu.magika.students.StudentOfflinePaymentList.class);
        ...
        processingfees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(StudentFees.this, com.edu.magika.students.StudentProcessingFees.class);
                startActivity(intent);
            }
        });
        loaddata();
...
//                        Log.i("ABCD", "onResponse: "+result);
                        if (true) {
                            ...
                            currency_price = currency_price==""?"1":currency_price;
                            JSONObject grandTotalDetails = object.getJSONObject("grand_fee");

                            Log.d("feesCheck", "onResponse: " + grandTotalDetails);
                            JSONArray transportfeesArray = object.getJSONArray("transport_fees");
                            Log.d("feesCheck", "onResponse: " + transportfeesArray);

                            String a = Utility.changeAmount(grandTotalDetails.getString("amount"),currency,currency_price);

                            gtAmtTV.setText(currency + a);
                            ...
                            for(int i = 0; i < dataArray.length(); i++) {
                                ...
                                for(int j = 0; j<feesArray.length(); j++) {
                                    ...
                                    String getAmountShow =  feesArray.getJSONObject(j).getString("amount");
                                    System.out.println("Fee show"+getAmountShow);
                            ...
                            JSONArray transportfeesArray1 = object.getJSONArray("transport_fees");
                            Log.d("feesCheck", "onResponse: " + transportfeesArray1);

                            JSONArray duefee = object.getJSONArray("student_due_fee");
                            Log.d("feesCheck", "onResponse: " + duefee);

                            JSONArray discountfee = object.getJSONArray("student_discount_fee");
                            Log.d("feesCheck", "onResponse: " + discountfee);
                            ...
                            adapter = new StudentFeesAdapter(StudentFees.this, feesIdList, feesnameList, feesCodeList, dueDateList, amtList, paidAmtList, balanceAmtList, feesDepositIdList, feesSessionIdList, statusList, feesDetails, feesTypeId, feesCat, discountNameList, discountAmtList, discountStatusList, discountpayment_idList, discAmtList, fineAmtList, amtfineList, transportdueDateList, transportamtfineList, transportpaidAmtList, transportdiscAmtList, transportbalanceAmtList, transportfeesDepositIdList, transportamtList, transportfineAmtList, transportstatusList);
                            feesList.setAdapter(adapter);

                            //System.out.println("Amount listt "+amtList);
