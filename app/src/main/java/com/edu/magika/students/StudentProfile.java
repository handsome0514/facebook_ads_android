...
import com.edu.magika.adapters.StudentProfileAdapter;
import com.edu.magika.fragments.StudentProfileParentFragment;
import com.edu.magika.fragments.StudentProfilePersonalFragment;
...
public class StudentProfile extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Utility.isConnectingToInternet(StudentProfile.this)){
    ...
    private void getDataFromApi (String bodyParams) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(StudentProfile.this, R.string.apiErrorMsg, Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
